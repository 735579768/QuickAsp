...
if(kfguin)
{
  ...
  if(type==1 && kf_getCookie('hasshown')==0)
  {
      ...
      window.setTimeout("kf_sleepShow()",6000);
      //kf_sleepShow();
  }
...
{
	window.open('http://wpa.qq.com/msgrd?v=3&uin='+kfguin+'&Site='+companyname+'&Menu=yes', '_blank', 'height=544, width=644,toolbar=no,scrollbars=no,menubar=no,status=no');
